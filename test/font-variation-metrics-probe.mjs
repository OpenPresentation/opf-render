...
try{
 ...
 for(const record of records){
  ...
  for(const item of instanceCases(record)){
   ...
   inputs.push({id:item.id,coordinates:item.coordinates,glyphId,unitsPerEm:face.upem,fontkitAdvance:glyph.advanceWidth,harfbuzzAdvance:integerAdvance,harfbuzzPreciseAdvance:preciseAdvance});
  }
